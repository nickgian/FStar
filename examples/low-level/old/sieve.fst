...
val multiplesMarkedAsDividesIff :
 ...
 -> Lemma
   ...
   (ensures (markedIffDividesOrInit n lo (reveal initv) (reveal newv)))
      ...
      [smt_pat (markedIffDividesOrInit n lo (reveal initv) (reveal newv))]
...
let innerLoop n lo li res initres =
  (unscopedWhile
    ...
    (*the part below has no computaional content; why does smt_pat not work?*)
...
val markedIffHasDivisorSmallerThanInc :
  ...
  -> Lemma
      ...
      (*[smt_pat (markedIffHasDivisorSmallerThan n (lo+1) neww)]*)
