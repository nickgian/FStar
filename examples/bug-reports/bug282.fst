...
assume val lem2: u:unit -> Lemma (requires True) (ensures (p u)) [smt_pat (p u)]
...
got expression "Bug282.lem2" of type "(u:Prims.unit -> Lemma (Prims.unit) Prims.l_True, (Bug282.p u@0), (Prims.Cons (Prims.smt_pat (Bug282.p u@0)) (Prims.Nil )))"
*)
