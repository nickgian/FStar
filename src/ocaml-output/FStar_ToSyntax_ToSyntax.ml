...
and desugar_formula:
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___230_6201 = t in
        {
          FStar_Syntax_Syntax.n = (uu___230_6201.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.tk = (uu___230_6201.FStar_Syntax_Syntax.tk);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars = (uu___230_6201.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___231_6231 = b in
             {
               FStar_Parser_AST.b = (uu___231_6231.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___231_6231.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___231_6231.FStar_Parser_AST.aqual)
             }) in
        ...
        | (Some a,k) ->
            ...
            (match uu____6273 with
             | (env1,a1) ->
                 let a2 =
                   let uu___232_6281 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___232_6281.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___232_6281.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
          ...
          (fun uu____6485  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___233_6513 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___233_6513.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___233_6513.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___233_6513.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (Some a,k) ->
                        ...
                        (match uu____6523 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___234_6535 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___234_6535.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___234_6535.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
           ...
           (match uu____6828 with
            | (formals,uu____6838) ->
                (match formals with
                 | [] -> []
                 | uu____6852 ->
                     let filter_records uu___214_6860 =
                       match uu___214_6860 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___215_6990 =
            match uu___215_6990 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___216_7067 =
            match uu___216_7067 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___217_7180 =
            match uu___217_7180 with
               ...
               | (uu____7399,uu____7400,se,uu____7402) ->
                   let se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let uu___235_7446 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, [], t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___235_7446.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals = quals2;
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___235_7446.FStar_Syntax_Syntax.sigmeta)
                         }
                       ...
                       FStar_All.pipe_right (Prims.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___236_10242 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___237_10243 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___237_10243.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___237_10243.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___236_10242.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___236_10242.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___236_10242.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___236_10242.FStar_Syntax_Syntax.lbdef)
                               })) in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___238_10301 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___238_10301.FStar_Parser_AST.prange)
                       }
                   | uu____10302 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___239_10306 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___239_10306.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___239_10306.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___239_10306.FStar_Parser_AST.attrs)
                      }) in
