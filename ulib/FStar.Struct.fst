...
: Lemma
  ...
  [smt_pat (path_includes PathBase p)]
= match p with
  | PathBase -> ()
...
: Lemma
  ...
  [smt_pat (live h (gfrom_buffer_index p i))]
= ()
...
: Lemma
  ...
  [smt_pat (contains h (gfrom_buffer_index p i))]
= ()
...
: Lemma
  ...
  [smt_pat (as_value h (gfrom_buffer_index p i)); smt_pat (Buffer.contains h p)]
= ()
...
: Lemma
  ...
  [smt_pat (contains h p2); smt_pat (includes p1 p2)]
= includes_ind
...
: Lemma
  ...
  [smt_pat (disjoint (gfrom_buffer_index p1 i1) (gfrom_buffer_index p2 i2))]
= ()
...
: Lemma
  ...
  [smt_pat (disjoint (gfrom_buffer_index p i1) (gfrom_buffer_index p i2))]
= ()
